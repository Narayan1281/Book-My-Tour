...
})({"9Vo4J":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "3020a6602daf0cf3";
module.bundle.HMR_BUNDLE_ID = "0bbfbaa684279ce0";
"use strict";
...
if (forgotPasswordForm) forgotPasswordForm.addEventListener("submit", (e)=>{
    ...
    const email = document.getElementById("email").value;
    // console.log(email);
    (0, _resetPassword.sendResetLink)(email);
...
},{"./mapbox":"kbyYO","./login":"56p97","./updateSettings":"fOvNa","./stripe":"4PpKh","./alerts":"dwfDI","./resetPassword":"6NfU5"}],"kbyYO":[function(require,module,exports) {
...
},{"./alerts":"dwfDI","@parcel/transformer-js/src/esmodule-helpers.js":"2RUzy"}],"dwfDI":[function(require,module,exports) {
...
},{"./alerts":"dwfDI","@parcel/transformer-js/src/esmodule-helpers.js":"2RUzy"}],"4PpKh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./alerts":"dwfDI","@parcel/transformer-js/src/esmodule-helpers.js":"2RUzy"}],"6NfU5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "sendResetLink", ()=>sendResetLink);
var _alerts = require("./alerts");
const sendResetLink = async (email)=>{
    try {
        ...
        if (res.data.status === "success") (0, _alerts.showAlert)("success", res.data.message, 15);
    } catch (err) {
        (0, _alerts.showAlert)("error", err.response.data.message, 15);
    }
};

},{"./alerts":"dwfDI","@parcel/transformer-js/src/esmodule-helpers.js":"2RUzy"}]},["9Vo4J","8tp2c"], "8tp2c", "parcelRequire11c7")
